<script lang="ts">
    ...
    async function resetAccount() {
        ...
        try {
            ...
            if (r.status === 409) {
                notification = "Neveljavno geslo ali uporabniško ime! Preverite, če ste vnesli tistega, ki ga uporabljate za eAsistent.";
                snackbarWithClose.open();
                return;
            }
            if (r.status === 500) {
...
{#if token === undefined || token === "" || token === null}
    <main>
        <Snackbar bind:this={snackbarWithClose}>
            <Label>Če tak uporabnik obstaja, mu je bilo sporočilo poslano. Če ni bilo poslano, poskusite znova čez 5
                minut ali pa kontaktirajte glavnega razvijalca.</Label>
            <Actions>
        ...
        <div class="center">
            ...
            <p/>
            Zahtevek bo verjetno razrešil vse probleme s prijavo v eAsistent, a naj se to uporabi kot zadnja možnost, saj
            resetira vaše Lo.Polis podatke in vaš Ringo ključ. <br>
            Če ne prejmete elektronskega sporočila po kliku na naslednji gumb, kontaktirajte razvijalca na <a
                href="mailto:mitja.severkar@gimb.org">mitja.severkar@gimb.org</a>.
            <p/>
...
{:else}
    <main>
        ...
        <div class="center">
            ...
            <Textfield type="text" bind:value={username} label="Uporabniško ime" style="width: 80%;"
                       helperLine$style="width: 80%;">
                <HelperText slot="helper" style="left: 12%; position: relative;">eAsistent uporabniško ime</HelperText>
                <Icon class="material-icons" slot="leadingIcon">person</Icon>
            </Textfield>
            <p/>
            <Textfield type={passwordVisibility ? "text" : "password"} bind:value={password} label="Geslo"
                       style="width: 80%;" helperLine$style="width: 80%;">
                ...
                <HelperText slot="helper" style="left: 12%; position: relative;">eAsistent geslo</HelperText>
            ...
            Zahtevek bo verjetno razrešil vse probleme s prijavo v eAsistent, a naj se to uporabi kot zadnja možnost, saj
            resetira vaše Lo.Polis podatke in vaš Ringo ključ. <br>
            Če ponastavitev ne deluje po kliku na naslednji gumb, kontaktirajte razvijalca na <a
                href="mailto:mitja.severkar@gimb.org">mitja.severkar@gimb.org</a>.
            <p/>
