...
<main>
    ...
    <div class="center">
        <div style="padding: 10px; background-color: darkorange; border-radius: 10px;">
            <h2>Pomembno obvestilo</h2>
            Dragi bodoči prvošolci!

            <p/>

            Če opažate to aplikacijo, še malo potrpite s prijavo. V prihodnjem šolskem letu, 2024/2025, bo Gimnazija Bežigrad na žalost vseh zamenjala svoj prejšnji šolski informacijski sistem, GimSIS, z eAsistentom. In ne, to ni všeč ne meni, ne drugim.

            <p/>

            Ker je BežiApp osnovan na GimSISu in direktno črpa podatke iz tam, moram na novo napisati celotno zaledje, kar pa pri velikosti, kakršno je dosegel BežiApp vsekakor ni lahko. Obljubljam pa, da bo do zadnjega tedna pred začetkom šole BežiApp ponovno odprt za vse.

            <p/>

            Do takrat pa vam lepe počitnice želi
